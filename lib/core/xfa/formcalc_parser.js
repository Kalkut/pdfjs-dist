...
class AstBinaryOperator extends Leaf {
  ...
  isSomPredicate() {
    return this.isDotExpression() || Operators.lt.id <= this.id && this.id <= Operators.or.id && (this.left.isDotExpression() && this.right.isConstant() || this.left.isConstant() && this.right.isDotExpression() || this.left.isDotExpression() && this.right.isDotExpression());
  }
