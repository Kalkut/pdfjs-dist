...
export type RenderParameters = {
    ...
    /**
     * - An XRSession object from the Webxr api.
     */
    xrSession?: Object | undefined;
    /**
...
export class PDFPageProxy {
     ...
     */
    render({ xrSession, canvasContext, viewport, intent, annotationMode, transform, canvasFactory, background, optionalContentConfigPromise, annotationCanvasMap, pageColors, printAnnotationStorage, }: RenderParameters): RenderTask;
    /**
